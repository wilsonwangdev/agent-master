...
1. Read [CLAUDE.md](CLAUDE.md) — it's the project's architecture map and conventions
...
3. Make atomic commits with prefixed messages (see CLAUDE.md for conventions)
...
This repo is designed to be agent-ready. CLAUDE.md is your entry point — it contains the architecture map, build commands, safety rules, and git workflow. Follow it as your primary instruction set. The `specs/`, `rules/`, and `journal/` directories provide additional context for decision-making.
